...
public class ValidaEdicionUsuarioAdminServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String Nickname,Nickname2,Contrasena,SexoS; //,Contrasena2,
            ...
            IdUsuario2s = request.getParameter("idUsuario2");
            Nickname2=request.getParameter("Nickname2");
            ...
            if((uadmin.getNickname())!=null & uadmin.getEstatus()==1 & uadmin.getIdperfil()==1){
                ...
                idUsuario2 = Integer.parseInt(IdUsuario2s);
                ue=UsuarioDao.getUsuarioById(idUsuario2);
    ...
    //                    idPerfil = p.getIdPerfil();
                        ...
                        out.println("FechaNacimeito ="+FechaNacimiento );
                        ...
                        ue.setNickname(Nickname2);
                        ue.setContrasena(Contrasena);
                       // u.setIdperfil(idPerfil);                        
                        ue.setNombreUsuario(nombreUsuario);                        
                        ue.setIdsexo(idSexo);    
                        ue.setFechaNacimiento(datesqlFechaNacimiento);                                              
                        ue.setPesoUsuario(pesoUsuario);
                        ue.setEstatura(Estatura);
                        ue.setOcupacion(Ocupacion);
                        ue.setIdActividad(idActividad);
                        //u.setFechaRegistro(date2);                                        
                        //u.setFechaUltVez(date2);                        
                        ue.setCaloriasDiarias(CaloriasDiarias);
                            ...
                            if (resultadoOcupacion!="OK"){
                                ...
                                if (resultadoEstatura!="OK"){
                                    ...
                                    if (resultadoPeso!="OK"){
                                        ...
                                        out.println("<script type='text/javascript'>");
                                        out.println("swal({title:'Ocurrio un error',");  
                                        out.println("text:'Error en la Contraseña "+resultadopassword+"',type:'error'},");
                                        out.println("function () {window.location.href = 'index.html?#four';});");
                                        out.println("</script>"); 
                                        out.println("</body>");
                                        out.println("</html>"); 
                ...
                out.println("<body>");
                out.println("<script type='text/javascript'>");
                out.println("swal({title: 'Lo sentimos :(',text: 'Usted no es Administrador.',type: 'error'},");
                out.println("function () {window.location.href = 'index.html?#four';});");
                out.println("</script>"); 
                out.println("</body>");
                out.println("</html>");         
            ...
            Logger.getLogger(ValidaEdicionUsuarioAdminServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
